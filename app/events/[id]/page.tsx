                    ...
                    {!event ? (
                        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-400">This event may have been removed or is unavailable.</p>
                                </div>
                            </div>
                            <div className="mt-6">
                                <Link
                        ...
                        <div className="space-y-6">
                            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5">
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-purple/20 via-black/0 to-brand-lime/15" />
                                <div className="relative p-6">
                                    <div className="flex items-start justify-between gap-4">
                                        <div className="min-w-0">
                                            <div className="flex items-center gap-2 mb-3">
                                                <span className="px-3 py-1 rounded-full bg-white/10 text-[11px] font-extrabold uppercase tracking-widest text-gray-200">
                                                    {event.type}
                                                </span>
                                                <span className="px-3 py-1 rounded-full bg-brand-purple/20 border border-brand-purple/30 text-[11px] font-extrabold uppercase tracking-widest text-brand-lime">
                                                    Upcoming
                                                </span>
                                            </div>
                                            <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white truncate">{event.title}</h1>
                                            <p className="mt-2 text-sm text-gray-300">
                                                {event.description || "Join us for this gathering."}
                                            </p>
                                        </div>
                                        <div className="size-12 rounded-2xl bg-white/10 border border-white/10 flex items-center justify-center">
                                    ...
                                    <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div className="rounded-xl border border-white/10 bg-black/30 p-4">
                                            <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Time</p>
                                            <p className="mt-2 text-sm font-extrabold text-white">
                                        ...
                                        <div className="rounded-xl border border-white/10 bg-black/30 p-4">
                                            ...
                                            <p className="mt-2 text-sm font-extrabold text-white">{event.location || "—"}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 flex flex-col sm:flex-row gap-3">
                                        ...
                                        <Link
                                            href="/events"
                                            className="flex-1 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 px-4 py-3 text-sm font-extrabold text-white transition-colors flex items-center justify-center gap-2"
                                        >
                            ...
                            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-sm font-extrabold text-white">Attendance (coming soon)</h2>
